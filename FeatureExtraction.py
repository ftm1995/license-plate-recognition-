...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("TrainFarsi/6m.jpg")            # read in training numbers image
    ...
    np.savetxt("y.txt", npaClassifications)           # write flattened images to file
    np.savetxt("x.txt", npaFlattenedImages)          #
